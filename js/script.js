...
function createLights() {
  ...
  ambientLight = new THREE.AmbientLight(0xe085a8, 0.1);
...
var AirPlane = function(){
  ...
  var matWindshield = new THREE.MeshPhongMaterial({color:Colors.white,transparent:true, opacity:.5, shading:THREE.FlatShading});;
  ...
  //Wheel Tire L with wheel axis due to clone
